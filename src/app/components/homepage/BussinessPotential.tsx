          ...
          <div className="flex justify-start flex-wrap gap-[35px] xl:flex-col">
            <div className="flex justify-start gap-[20px] items-center">
              <div className=" w-[90px] h-[90px] flex justify-center items-center bg-[#ffffff] rounded-full">
                <Image src="/assets/bicon1.png" width={32} height={32} alt="" />
              </div>
              <div>
                <h5
                ...
                >
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }: any) => (
                      <div>
                        {isVisible ? (
                          <CountUp start={0} scrollSpyOnce={true} end={1869} />
                        ) : (
                          1869
                        )}
                        +
            ...
            <div className="flex justify-start gap-[20px] items-center">
              <div className=" w-[90px] h-[90px] flex justify-center items-center bg-[#ffffff] rounded-full">
                <Image src="/assets/bicon2.png" width={32} height={32} alt="" />
              </div>
              <div>
                <h5
                  className={`font-spaceGrotesk  font-[500] leading-[95%] text-[38px]`}
            ...
            <div className="flex justify-start gap-[20px] items-center">
              <div className=" w-[90px] h-[90px] flex justify-center items-center bg-[#ffffff] rounded-full">
                <Image src="/assets/bicon3.png" width={32} height={32} alt="" />
              </div>
              <div>
                <h5
                  className={`font-spaceGrotesk  font-[500] leading-[95%] text-[38px]`}
                >
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }: any) => (
                      <div>
                        {isVisible ? (
                          <CountUp start={0} scrollSpyOnce={true} end={5} />
                        ) : (
                          5
                        )}
                        +
