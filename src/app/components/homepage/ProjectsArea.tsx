        ...
        <div className="flex justify-center mt-[70px] gap-[20px] xl:gap-y-[80px] flex-wrap items-center">
          <div className="group">
            <Image
              ...
              width={695}
              height={300}
              className="h-auto w-full block lg:w-[550px] group-hover:scale-105 transition-all duration-500 rounded-[50px] skewElem"
              alt=""
            />
            <div className="px-[40px] w-full lg:w-[550px] pt-[40px]">
              ...
              <p
                className={`${spaceGrotesk.className} flex flex-wrap  items-center gap-[10px] text-[#828282] text-[18px]`}
              >
                {" "}
          ...
          <div className="group">
            <Image
              ...
              width={695}
              height={300}
              className="h-auto block w-full lg:w-[550px] group-hover:scale-105 transition-all duration-500 rounded-[50px] skewElem"
              alt=""
            />
            <div className="px-[40px] w-full lg:w-[550px] pt-[40px]">
              <h6
